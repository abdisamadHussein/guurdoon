...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="page-wrapper">
        <div class="container-xl">
            ...
            <div class="page-body" ID="fee" runat="server">
        ...
        <div class="page-body" id="Dhedig" runat="server" accesskey="public">
                                 ...
                                 <div class="col-xl-12">
                                     <div class="row">
                                         <div class="d-flex align-content-center mb-3">
                                             ...
                                             <h2 class="form-label ms-2 mx-2 ">Ma Qabtaa Cudurada Faafa?</h2>
                                             <div class="col-xl-4">
                                                 <asp:RadioButtonList ID="cudurada" runat="server" RepeatDirection="Horizontal" Width="162px" AutoPostBack="True">
                                                     <asp:ListItem>Haa</asp:ListItem>
                                                     <asp:ListItem Selected="True">Maya</asp:ListItem>
                                                 </asp:RadioButtonList>
                                             </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="d-flex align-content-center mb-3">
                                                ...
                                                <h2 class="form-label ms-2 mx-2 ">Ma shaqeysaa?</h2>
                                              <div class="col-xl-4">
                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" Width="162px" AutoPostBack="True">
                                                     <asp:ListItem>Haa</asp:ListItem>
                                                     <asp:ListItem Selected="True">Maya</asp:ListItem>
                                                </asp:RadioButtonList>
                                                  </div>
                                 ...
                                 <div class="col-xl-12">
                                     <div class="row">
                                         <div class="d-flex align-content-center mb-3">
                                             ...
                                             <h2 class="form-label ms-2 mx-2 ">Ma Qabtaa Cudurada Faafa?</h2>
                                             <div class="col-xl-4">
                                                 <asp:RadioButtonList ID="RadioButtonList3" runat="server" RepeatDirection="Horizontal" Width="162px" AutoPostBack="True">
                                                     <asp:ListItem>Haa</asp:ListItem>
                                                     <asp:ListItem Selected="True">Maya</asp:ListItem>
                                                 </asp:RadioButtonList>
                                             </div>
           ...
           <div class="page-body" id="Lab" runat="server">
            <div class="container-narrow">
                <div class="col-12">
                </div>
                <div class="row row-cards card d-flex  align-content-center">
                   ...
                   <div class="col-xl-12">
                                     <div class="row">
                                         <div class="d-flex align-content-center mb-3">
                                             ...
                                             <h2 class="form-label ms-2 mx-2 ">Ma Qabtaa Cudurada Faafa?</h2>
                                             <div class="col-xl-4">
                                                 <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" Width="162px" AutoPostBack="True">
                                                     <asp:ListItem>Haa</asp:ListItem>
                                                     <asp:ListItem Selected="True">Maya</asp:ListItem>
                                                 </asp:RadioButtonList>
                                             </div>
