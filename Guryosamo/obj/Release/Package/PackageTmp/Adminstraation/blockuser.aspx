<%@ Page Title="" Language="C#" MasterPageFile="~/Adminstraation/Adminstration.Master" AutoEventWireup="true" CodeBehind="blockuser.aspx.cs" Inherits="Guryosamo.Adminstraation.blockuser" %>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div>
                                                    <asp:Button class="btn btn-success w-50" ID="btncheck" runat="server" Text="Block" OnClick="btncheck_Click"   />
