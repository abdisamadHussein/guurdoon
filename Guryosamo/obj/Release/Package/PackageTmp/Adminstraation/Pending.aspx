<%@ Page Title="" Language="C#" MasterPageFile="~/Adminstraation/Adminstration.Master" AutoEventWireup="true" CodeBehind="Pending.aspx.cs" Inherits="Guryosamo.Adminstraation.Pending" %>
                                ...
                                <asp:GridView ID="GridView1" CssClass="table table-vcenter card-table w-100 h-auto" runat="server" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="service" HeaderText="Services" />
                                          <asp:BoundField DataField="pay_no" HeaderText="Sender Detail" />
                                    </Columns>
                                </asp:GridView>
